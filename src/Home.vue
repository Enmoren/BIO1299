          ...
          <v-list-item-content>
            <v-list-item-title>
              ...
              <v-badge
                color="red"
                inline
                :content="'+' + l.today.confirmed"
                :dark="isDarkTheme"
                style="margin-top: 0px;"
              >
                <span class="font-weight-bold" style="margin-top: 0px;">
    ...
    <v-content>
      ...
      <v-dialog width="500" v-model="dialog" :fullscreen="$vuetify.breakpoint.xsOnly">
        <v-card>
          ...
          <v-card-text>
            <div>
              <!-- <p>Country/Region: {{ selected['CNAME'] }}</p> -->
              <p v-show="selected['Province/State']">
                Country/Region: {{ selected['Province/State'] }}
              </p>
              ...
              <div style="width:49%;float:right">
                ...
                <p>Fatality Rate:{{ ((selected.death * 100) / selected.confirmed).toFixed(2) }}%</p>
              </div>
              <div>
